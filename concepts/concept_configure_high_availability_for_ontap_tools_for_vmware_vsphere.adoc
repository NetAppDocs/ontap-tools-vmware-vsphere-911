...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability.html[VMware vSphere Documentation: Creating and Using vSphere HA Clusters^]
