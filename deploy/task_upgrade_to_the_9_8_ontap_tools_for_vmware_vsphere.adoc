...
summary: 'You can perform an in-place upgrade to the latest release of ONTAP tools from your existing 9.7.1 or later setup following the instructions provided here.'
---
...
NOTE: You can perform an in-place upgrade to the latest release of ONTAP tools only from your existing 9.7P1 or later versions. When you upgrade to 9.7.1 release of ONTAP tools and you want to use vVols replication, then you will need to setup one more vCenter Server with ONTAP tools with Site Recovery Manager (SRM) installed.
